				  ...
				  <div class="userform">
					<form class="login-form" method="post" action="PasswordChangeServlet">
						<h2>Passwort Ändern</h2>
				      	<input type="password" placeholder="Password alt" name="passwordneu"/>
				      	<input type="password" placeholder="Password neu" name="passwordalt1"/>
				      	<input type="password" placeholder="Password neu wiederholen" name="passwordalt2"/>
